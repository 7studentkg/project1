...
urlpatterns = [
    ...
    path('client/<int:client_id>/signature/', SignatureCreate.as_view(), name='signature-create'),
    path('client/<int:client_id>/signature/<int:signature_id>/', SignatureDetailView.as_view(), name='signature-detail'),
